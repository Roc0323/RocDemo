package cn.roc.rocdemo.imagewatcher;
...
public class ImageWatcher extends FrameLayout implements GestureDetector.OnGestureListener, ViewPager.OnPageChangeListener {
    ...
    public ImageWatcher(Context context, AttributeSet attrs) {
        ...
        vPager.setBackgroundColor(Color.parseColor("#ffffff"));
        ...
        frameparams.setMargins(0, RocApplication.dip2px(context,15),0, 0);

        tCurrentIdx = new TextView(context);

        tCurrentIdx.setLayoutParams(frameparams);

        addView(tCurrentIdx);

        tCurrentIdx.setTextColor(0xFF000000);

        tCurrentIdx.setTextSize(16);

        tCurrentIdx.setBackgroundColor(Color.parseColor("#00FFFFFF"));
