...
public class MaterialProgressView extends View {
    ...
    public void setIsblack(boolean isblack) {
        ...
        mDrawable = new MaterialProgressDrawable(getContext(), this,isblack);
        mDrawable.setAlpha(255);
        mDrawable.setCallback(this);
        invalidate();
    }
    ...
    public static class MaterialProgressDrawable extends Drawable implements Animatable {
        ...
        private final int[] COLORS_black = new int[]{
                0xFFFFFFFF,
                0xFFFFFFFF,
                0xFFFFFFFF,
                0xFFFFFFFF
        ...
        public MaterialProgressDrawable(Context context, View parent, boolean  isblack) {
            mParent = parent;
            mResources = context.getResources();
            mRing = new Ring(mCallback);
            mRing.setColors(COLORS_black);
            setSizeParameters(CIRCLE_DIAMETER, CIRCLE_DIAMETER, CENTER_RADIUS, STROKE_WIDTH);
            setupAnimators();
        }
