...
public abstract class NineGridLayout extends ViewGroup {
    ...
    public void setUrlList(List<String> urlList,List<String> urlList2) {
    ...
    private RatioImageView createImageView(final int i, final String url) {
        ...
        imageView.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                onClickImage(i, url, mUrlList,mUrlList2,imageView,mImageList);
            }
        });
        return imageView;
    }
...
//        params.width = width;
    ...
    protected abstract void onClickImage(int position, String url, List<String> urlList,List<String> urlList2,RatioImageView imageView,List<ImageView> imageList);
}
